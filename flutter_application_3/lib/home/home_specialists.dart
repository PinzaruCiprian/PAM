    ...
    return BlocBuilder<MedicineBloc, MedicineState>(
      builder: (context, state) {
        if (state is MedicineFeedLoaded) {
          final specialists = (state.medicineFeed['specialists'] as List<dynamic>)
                    ...
                    children: specialists.map((specialist) {
                      return Padding(
                        ...
                        child: _SpecialistCard(
                          ...
                          speciality: specialist['speciality'] as String,
                          imageUrl: specialist['image'] as String,
                          rating: (specialist['rating'] as num).toDouble(),
                          available: specialist['available'] as bool,
                          onTap: (context) {
                            Navigator.push(
                              context,
                              MaterialPageRoute(
